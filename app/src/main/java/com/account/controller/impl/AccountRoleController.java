...
public class AccountRoleController implements RoleApi {
  ...
  public ResponseEntity<AccountRoleReturnModel> apiV1AccountAccountIdRolePost(
      ...
      @Valid AccountRoleRequestModel accountRoleRequestModel)
      throws Exception {
    Tuple2<AccountRoleReturnModel, Boolean> tuple2 =
        accountRoleService.save(accountId, accountRoleRequestModel);
    ...
    return ResponseEntity.status(HttpStatus.valueOf(statusCode))
        ...
        .body(accountRoleReturnModel);
  }

  @Override
  public ResponseEntity<AccountRoleIDReturnModel> apiV1AccountAccountIdRoleRoleGet(
      UUID accountId, RoleEnum role) throws Exception {
