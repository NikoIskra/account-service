...
private static AccountRoleRequestModel createAccountRoleRequestModel() {
    ...
    void testConvertRequestmodelToAccountRole() {
        ...
        AccountRole returnAccountRole = entityConverterService.convertRequestmodelToAccountRole(uuid, accountRoleRequestModel);
        verify(modelMapper).map(any(), any());
    ...
    void testConvertAccountRoleToReturnModel() {
        AccountRole accountRole = createAccountRole();
        AccountRoleReturnModelResult accountRoleReturnModelResult = createAccountRoleReturnModelResult();
        when(modelMapper.map(accountRole, AccountRoleReturnModelResult.class)).thenReturn(accountRoleReturnModelResult);
        AccountRoleReturnModel returnModel = entityConverterService.convertAccountRoleToReturnModel(accountRole);
        verify(modelMapper).map(any(), any());
        assertEquals(returnModel.isOk(), true);
    ...
    void testConvertAccountRoleToIdReturnModel() {
        AccountRole accountRole = createAccountRole();
        AccountRoleIDReturnModelResult accountRoleIDReturnModelResult = createAccountRoleIDReturnModelResult();
        when(modelMapper.map(accountRole, AccountRoleIDReturnModelResult.class)).thenReturn(accountRoleIDReturnModelResult);
        AccountRoleIDReturnModel returnModel = entityConverterService.convertAccountRoleToIdReturnModel(accountRole);
        verify(modelMapper).map(any(), any());
        assertEquals(returnModel.isOk(), true);
