...
public class AccountValidatorTest {
  ...
  @InjectMocks AccountValidator accountValidator;
  ...
  void testValidateRequestData() {
    ...
    assertDoesNotThrow(() -> accountValidator.validateRequestData(requestModel));
  }
  ...
  void testValidateRequestData_conflict() {
    ...
    RequestModel requestModel = createRequestModel();
    assertThrows(ConflictException.class, () -> accountValidator.validateRequestData(requestModel));
  }
}
