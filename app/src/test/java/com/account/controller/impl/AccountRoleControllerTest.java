...
public class AccountRoleControllerTest {
  ...
  RequestModel validAccountRequestModel =
      new RequestModel()
  ...
  void testInsertEmptyAccountRole() throws Exception {
    ...
    mvc.perform(
            MockMvcRequestBuilders.post("/api/v1/account/" + account.getId() + "/role")
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void testInsertAccountRoleWithNoAccount() throws Exception {
    mvc.perform(
            MockMvcRequestBuilders.post("/api/v1/account/26bea1b4-ea70-4df2-836b-3ee2f5cece13/role")
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void testGetAccountRoleWithNoAccount() throws Exception {
    mvc.perform(
            MockMvcRequestBuilders.get(
                    "/api/v1/account/4ba8167d-0825-4eff-bd65-ec233bd7199e/role/DELIVERY")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
  }
}
